...
execute at @e[type=marker,nbt={data:{puzzle:"mannequin_indicator"}}] as @a[distance=..5] if score @s puzzle.mann.index != @e[type=marker,nbt={data:{puzzle:"mannequin_indicator"}},distance=..5,limit=1] puzzle.mann.index run function puzzle:mann/initiate
