...
scoreboard players operation $yIncremental puzzle.value.temp *= $yIncremental puzzle.value ##-1
scoreboard players operation $yIncremental puzzle.value.temp += $yIncrementalB puzzle.value ##2
