...
execute store result score $xIncrementalYaw puzzle.value run data get entity @s Rotation[0]
scoreboard players operation $xIncrementalYaw puzzle.value *= $-1 puzzle.value
execute store result storage puzzle:mannstats yaw float 1 run scoreboard players get $xIncrementalYaw puzzle.value
