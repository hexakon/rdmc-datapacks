...
execute as @s[scores={puzzle.mann.styling=4}] at @s run function puzzle:mann/scans/x_incremental
execute as @s[scores={puzzle.mann.sneaking=1..,puzzle.mann.sneaking.temp=0}] at @s run function puzzle:mann/actions/sneak
