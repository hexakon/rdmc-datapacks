...
execute as @s[scores={puzzle.mann.sneaking=..1,puzzle.mann.sneaking.temp=1..}] at @s run function puzzle:mann/actions/unsneak
execute as @s[scores={puzzle.mann.sneaking=2..}] run scoreboard players set @s puzzle.mann.sneaking 0