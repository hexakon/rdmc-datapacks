...
execute as @s[scores={puzzle.man.sneaking=1..,puzzle.mnan.sneaking.temp=..1}] at @s run function puzzle:mann/actions/sneak
execute as @s[scores={puzzle.man.sneaking=..1,puzzle.mnan.sneaking.temp=1..}] at @s run function puzzle:mann/actions/unsneak
