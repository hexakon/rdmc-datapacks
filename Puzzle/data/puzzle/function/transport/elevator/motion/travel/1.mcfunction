...
execute at @e[tag=puzzle.elevator.num,scores={puzzle.value=1}] run playsound puzzle:puz.elevator.presence block @a ~ ~ ~ 0.14 1
...
execute positioned 950020 39 -10 run playsound puzzle:puz.elevator.presence block @a[distance=..3] ~ ~ ~ 0.2 1