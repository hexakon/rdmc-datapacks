...
execute as @e[tag=puzzle.elevator.num,scores={puzzle.value=1}] run data modify entity @s text set value [{"score":{"name":"currentFloor.1","objective":"puzzle.value"},"color":"gold"}]
