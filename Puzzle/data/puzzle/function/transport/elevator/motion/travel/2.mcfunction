...
execute at @e[tag=puzzle.elevator.num,scores={puzzle.value=2}] run playsound puzzle:puz.elevator.presence block @a ~ ~ ~ 0.14 1
...
execute positioned 950024 39 -10 run playsound puzzle:puz.elevator.presence block @a[distance=..3] ~ ~ ~ 0.2 1