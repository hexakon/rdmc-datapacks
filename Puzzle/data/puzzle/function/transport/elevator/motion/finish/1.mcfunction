execute if score currentFloor.1 puzzle.value matches 1 positioned 950020 37 -10 as @a[distance=..2] at @s run tp @s ~ ~-37 ~ ~ ~
execute if score currentFloor.1 puzzle.value matches 2 positioned 950020 37 -10 as @a[distance=..2] at @s run tp @s ~ ~-32 ~500
