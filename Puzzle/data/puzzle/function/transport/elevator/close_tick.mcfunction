...
$execute as @s[scores={puzzle.value.temp=175..200}] as @e[tag=puzzle_increment_3,tag=puz_door_L,scores={puzzle.value=$(index)}] at @s run tp @s ~0.02 ~ ~
$execute as @s[scores={puzzle.value.temp=175..200}] as @e[tag=puzzle_increment_3,tag=puz_door_R,scores={puzzle.value=$(index)}] at @s run tp @s ~-0.02 ~ ~
...
$execute as @s[scores={puzzle.value.temp=125..150}] as @e[tag=puzzle_increment_1,tag=puz_door_L,scores={puzzle.value=$(index)}] at @s run tp @s ~0.02 ~ ~
$execute as @s[scores={puzzle.value.temp=125..150}] as @e[tag=puzzle_increment_1,tag=puz_door_R,scores={puzzle.value=$(index)}] at @s run tp @s ~-0.02 ~ ~
